...
//creating global variable to store the browser content like token
let webContext;
//this global variable is used in the below 2 test methods
...
test.beforeAll(async ({ browser }) => {
    ...
    //storing browser content like token in 'state.json' file
